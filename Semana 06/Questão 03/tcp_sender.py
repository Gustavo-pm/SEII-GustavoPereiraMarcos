...
import sys # Importa biblioteca

TCP_IP = "127.0.0.1" # Define o IP
FILE_PORT = 5005 # Define a porta de envio
DATA_PORT = 5006 # define a porta de recepção
buf = 1024 1024 # Define o tamanho do buffer
file_name = sys.argv[1] # Recolhe o nome do arquivo
...
try:
    ...
    sock.connect((TCP_IP, FILE_PORT))  # Inicia a conexão usando o ip e porta de envio de arquivo
    sock.send(file_name.encode('utf-8')) # Envia o nome do arquivo
